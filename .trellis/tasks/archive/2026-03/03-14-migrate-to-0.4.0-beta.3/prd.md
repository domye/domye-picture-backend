# Migration Task: Upgrade to v0.4.0-beta.3

**Created**: 2026-03-14
**From Version**: 0.3.10
**To Version**: 0.4.0-beta.3
**Assignee**: name=domye
initialized_at=2026-03-03T21:25:32.668083

## Status

- [x] Review migration guide
- [x] Update custom files (no customization needed)
...
- Version updated to 0.4.0-beta.3
- New unified commands (`before-dev`, `check`) are in place
- Old platform-specific commands removed
- All Python scripts verified working
