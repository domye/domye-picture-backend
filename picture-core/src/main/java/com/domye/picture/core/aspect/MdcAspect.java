package com.domye.picture.core.aspect;

import cn.hutool.core.util.StrUtil;
import com.domye.picture.core.annotation.MdcDot;
import com.domye.picture.core.mdc.MdcUtil;
...
public class MdcAspect implements ApplicationContextAware {
    ...
    @Pointcut("@annotation(com.domye.picture.core.annotation.MdcDot) || @within(com.domye.picture.core.annotation.MdcDot)")
