package com.domye.picture.api.manager.sentinel;
...
public class SentinelRulesManager {
    ...
    public void initDegradeRules() {
        // 单 IP 查看题目列表熔断规则
        DegradeRule slowCallRule = new DegradeRule("getPictureVOById")
                .setGrade(CircuitBreakerStrategy.SLOW_REQUEST_RATIO.getType()) // 添加缺失的右括号
        ...
        DegradeRule errorRateRule = new DegradeRule("getPictureVOById")
...
// 加载规则
    ...
    public void listenRules() throws Exception {
        ...
        WritableDataSource<List<FlowRule>> flowWds = new FileWritableDataSource<>(
                flowRulePath, this::encodeJson);
        // Register to writable data source registry so that rules can be updated
        ...
        WritableDataSource<List<DegradeRule>> degradeWds = new FileWritableDataSource<>(
