 ...
 */
public interface ActivityService extends IService<VoteActivity> {

    Long createVoteActivity(ActivityAddRequest activityAddRequest, HttpServletRequest request);
    

    ActivityDetailVO getActivityDetailVOById(Long id);
